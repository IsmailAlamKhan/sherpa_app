        ...
        children: <Widget>[
          Container(
            ...
            decoration: new BoxDecoration
              ...
              image: DecorationImage(image: AssetImage("assets/SIcon.png")),
            ),
          ),
          Container(
            height: 30,
            decoration: new BoxDecoration
              (
                ...
                image: DecorationImage(image: AssetImage("assets/SHERPA.png")),
          ),
          ),
          Container(
            height: 20,
            ...
            child: Column(
              children: <Widget> [
                ...
                TextFormField( //PASSWORD
                  ...
                  obscureText: true,
                  validator: (val) => val!.length < 6 ? 'Enter password 6+ char' : null,
                  onChanged: (val) {
                    setState(() {
                      password = val;
                    });
